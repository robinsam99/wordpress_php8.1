            ...
            <table class="form-table">
                <tr valign="top">
			        ...
			        <td>
                        ...
                        <span class="cli_form_help " style="margin-top:8px;"><?php _e('This will enable all cookie categories on clicking the accept button, no matter whether they are in the enabled or disabled state.', 'webtoffee-gdpr-cookie-consent'); ?></span>
