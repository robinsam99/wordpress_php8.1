...
<div class="activation_window">
	<h2 class="aw-title"><span><?php _e('Licence Activation', 'webtoffee-gdpr-cookie-consent');?></span></h2>
	<div class="aw-contents-container">
		<div id="aw-activation" class="content-row <?php echo $show_activation?>">
			<div class="aw-cell">
				<label class="aw-label"><?php _e('API Licence Key:', 'webtoffee-gdpr-cookie-consent');?></label>
				<input type="text" class="txt-api-key aw-textbox" placeholder="<?php _e('Licence Key', 'webtoffee-gdpr-cookie-consent');?>" value="" id="txt_licence_key">
			</div>
			<div class="aw-cell">
				<label class="aw-label">Email:</label>
				<input type="text" id="txt_email" class="aw-textbox" placeholder="<?php _e('Licence Email', 'webtoffee-gdpr-cookie-consent');?>" value="">
			</div>
			<div class="aw-cell">
				<label class="aw-label">&nbsp;</label>
				<input type="button" id="btn_licence_activate" class="aw-button aw-main-button" value="<?php _e('Activate', 'webtoffee-gdpr-cookie-consent');?>">
			</div>
			<div class="content-row" style="float: left; width: 100%;">
				<p class="aw-note-cell"><?php _e('Check', 'webtoffee-gdpr-cookie-consent');?> <a href="https://www.webtoffee.com/my-account/my-api-keys/" target="_blank">My Account</a> for API Keys and API Downloads.</p>
			</div>
		</div>
		<div id="aw-deactivation" class="content-row <?php echo $show_deactivation?>">
			...
			<div class="aw-deactivation-info">
				...
				<input type="button" id="btn_licence_deactivate" class="aw-button deacvation-button" value="<?php _e('Deactive', 'webtoffee-gdpr-cookie-consent');?>">
			</div>
		</div>
	</div>
</div>
