    ...
    */
    ...
    { 
        ...
        $out['cli-policy-preview'] = array(
            'title'   => __('Cookie Policy','webtoffee-gdpr-cookie-consent'),
            'content' =>Cookie_Law_Info_Cli_Policy_Generator::generate_page_content()
        );
        return $out;
    }
    ...
    public function add_admin_bar_menu($wp_admin_bar)
    {
        ...
        'title' => '<span style="color:red;"><input type="checkbox" name="cli_pg_toggle_preview_autoreload" /> '.__('Auto reload preview','webtoffee-gdpr-cookie-consent').'</span>',
        ));
    }
