	...
	$(function() {
		var CLI_cookie_scanner={
			...
			showSuccessScreen:function(success_msg,scan_id,total)
			{
				...
				if(total==1)
				{
					html+='<a class="button-secondary pull-right cli_export" style="margin-left:5px;" href="'+cookielawinfo_cookie_scaner.export_page_url+scan_id+'&cli_cookie_scaner='+cookielawinfo_cookie_scaner.nonces.cli_cookie_scaner+'">'+cookielawinfo_cookie_scaner.labels.export+'</a>';
