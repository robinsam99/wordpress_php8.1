...
<div class="wrap" id="cli_visitor_report_wrap">
    ...
    <a href="<?php print wp_nonce_url(admin_url('edit.php?post_type='.CLI_POST_TYPE.'&page=cli_visitor_report&report_history=export'), 'export', 'cookie_law_info_nonce');?>" class="page-title-action"><?php _e('Export Report', 'cookie-law-info'); ?></a>
