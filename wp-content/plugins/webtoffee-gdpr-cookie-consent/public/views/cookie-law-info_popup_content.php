...
$cli_privacy_readmore='<a class="cli-privacy-readmore" data-readmore-text="'.__('Show more', 'webtoffee-gdpr-cookie-consent').'" data-readless-text="'.__('Show less', 'webtoffee-gdpr-cookie-consent').'"></a>';
        ...
        <div class="cli-col-12 cli-align-items-stretch cli-px-0">
            <div class="cli-tab-footer">
                <?php if ($the_options['accept_all'] == true) { ?>
                    <a role="button" tabindex="0" class="cli_setting_save_button cli-btn"><?php echo __('Save & Accept', 'webtoffee-gdpr-cookie-consent'); ?></a>
                <?php } ?>
            </div>
        </div>
    </div> 
