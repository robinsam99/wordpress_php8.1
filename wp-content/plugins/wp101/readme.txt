...
Plus, the WP101 Video Tutorial Plugin also includes tutorial videos for WooCommerce, Jetpack, Yoast SEO, and Ninja Forms, provided those plugins are also installed and activated on the site in question. Videos for other popular plugins are in the works.
...
= 5.3 =
* Tested and verified for WordPress 5.6.
...
= 5.3 =
* Tested and verified for WordPress 5.6, plus some minor housekeeping.
